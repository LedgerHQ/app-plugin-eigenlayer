...
This directory contains non-regression tests for the eigenlayer plugin.
...
For example in the [plugin-eigenlayer CI](https://github.com/LedgerHQ/app-plugin-eigenlayer/actions/workflows/build_and_functional_tests.yml).


## Launching the tests

The plugin eigenlayer app comes with functional tests 
